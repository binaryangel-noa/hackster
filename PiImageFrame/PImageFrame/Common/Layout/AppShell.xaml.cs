...
using PImageFrame.Content.Layout.Controls;
...
namespace PImageFrame.Content.Layout
{
    ...
    public sealed partial class AppShell : Page
    {
        ...
        public static List<NavMenuItem> navlist = new List<NavMenuItem>(
            new[]
            {
                new NavMenuItem()
                {
                    ...
                    Label = "Basic Page",
                    DestPage = typeof(MainPageReference)
                },
                new NavMenuItem()
                {
                    Symbol = Symbol.Edit,
                    Label = "CommandBar Page",
                    DestPage = typeof(SecondPage)
                },
                //new NavMenuItem()
                //{
        ...
        private void NavMenuList_ItemInvoked(object sender, ListViewItem listViewItem)
        {
            ...
            if (item != null)
            {
                ...
                {
                    _navigationService.NavigateTo(item.DestPage.Name);
                }
            }
        }
