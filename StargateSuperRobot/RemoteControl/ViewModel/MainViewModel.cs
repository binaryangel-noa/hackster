...
namespace RemoteControl.ViewModel
{
    public class MainViewModel : ViewModelBase
    {
        ...
        private const string CONNECTIONSTRING_OWNER = "HostName=StarGateRoverHub.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=pLgvtfTmSdL2L/Gh5QsH731hl0+dH5/+Gpvmf7DicHM=";
            ...
            get
            {
                return _navigateCommand
                       ?? (_navigateCommand = new RelayCommand<string>(
                           p => _navigationService.NavigateTo(ViewModelLocator.MessageReceiverPageKey),
                           p => true));
            }
        }
        ...
        {
            string deviceId = Shared.Globals.DEVICE_ID;
        ...
        private async Task initialize()
        {
            try
            {
                ...
                mRegistryManager = RegistryManager.CreateFromConnectionString(CONNECTIONSTRING_OWNER);
                addDeviceAsync();
            }
            catch (Exception ex)
            {
